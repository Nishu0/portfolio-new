  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-8 mb-20 lg:flex-row">
        <div className="relative flex-1 p-8 rounded-2xl bg-gray-800/40 ring-1 ring-inset ring-gray-700/30">
          <div className="absolute inset-0 bg-dots fade-y opacity-70"></div>
          <div className="relative">
            <h2 className="text-2xl font-semibold tracking-tight">About me</h2>
            <div className="mt-6 space-y-4 font-medium leading-relaxed tracking-wide text-gray-400">
              <p>
                Hey! I'm Nisarg, a creative 20-year-old who loves building
                products with code.
              </p>
              <p>
        ...
        <div className="relative p-8 rounded-2xl bg-gray-800/40 ring-1 ring-inset ring-gray-700/30 xl:w-4/12">
          <div className="absolute inset-0 bg-dots fade-y opacity-70"></div>
          <div className="relative">
              ...
              <ol className="space-y-7">
                {experiences.map((exp, index) => (
                  <li key={index} className="flex items-center">
                    <div className="flex items-center justify-center flex-shrink-0 mt-6 overflow-hidden rounded-full h-9 w-9 ring-4 ring-gray-800 sm:mt-0 sm:h-10 sm:w-10">
                      <img
                        src={exp.logo}
                        alt={exp.company}
                        loading="lazy"
                    ...
                    <div className="relative w-full">
                      <div className="ml-5">
                        <div className="flex flex-col-reverse items-start justify-between gap-2 sm:flex-row sm:gap-4">
                          <a
                            className="-my-0.5 -ml-2 rounded-full px-2 py-0.5 text-sm font-medium transition-colors hover:bg-gray-700"
                            href={exp.link}
                            target="_blank"
